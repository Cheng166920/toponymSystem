...
//PtLayer5：边界点图层
export var BdyPtLayer=PtLayer.extend({
  queryHeader:"/toponym/toponym/extent/bd_point",
  isShow:false,
  ...
  pointToLayer:function(data){
    ...
    axiosdata.forEach(feature => {
      ...
      var marker = L.marker([geometry.coordinates[1],geometry.coordinates[0]], { icon: iconLib.getIconObj("bp") });
      marker.bindTooltip("边界点", {
        direction: 'right',
        permanent:true,
